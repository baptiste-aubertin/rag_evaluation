...
class DocumentSchema(BaseModel):
    text: str = Field(
        ...
        json_schema_extra={"example": "Trains are a very safe mode of transport..."},
    )
    score: Optional[float] = Field(
        None,
        description="Un score de pertinence (entre 0 et 1).",
...
class SampleSchema(BaseModel):
    query: str = Field(
        ...
        json_schema_extra={"example": "Why are there no seat belts on trains?"},
    )
